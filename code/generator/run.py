...
from code2nl_cross.model import Seq2Seq
...
def main():
    ...
    if args.do_train:
        ...
        for epoch in range(args.num_train_epochs):
            ...
            #                 t=t[:t.index(0)]
            #             # t=pred[0]
            #             # select_idx = (t == 0).nonzero(as_tuple=True)[0][0]
            #             # t = t[:select_idx]
            ...
            # print(matrix)
            #
            # if best_rouge < matrix['rouge2']:
            #     best_rouge = matrix['rouge2']
            #     print('save: ', epoch)
            ...
            #
            #     with open(os.path.join(args.output_dir, "test_{}.output".format(str(epoch))), 'w',
            #               encoding='utf-8') as f, open(os.path.join(args.output_dir, "test_{}.gold".format(str(epoch))),
            #                                            'w',
            #                                            encoding='utf-8') as f1, \
            #             open(os.path.join(args.output_dir, "result_{}.output".format(str(epoch))), 'w',
